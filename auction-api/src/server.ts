...
app.post('/registerAuctionInfo', async (req, res) => {
  try {
    ...
    var floor = req.body.floor as number;//req.body.cartId;
    var increment = req.body.increment as number;//req.body.cartId;
    var biddercap = req.body.biddercap as number;//req.body.cartId;
