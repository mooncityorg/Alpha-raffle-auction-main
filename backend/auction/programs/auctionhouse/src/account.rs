...
pub struct OpenAuction {
    ...
    pub bids: Vec<u64>,
    pub bid_token: Vec<u64>,

    pub highest_bidder: Pubkey,
    pub highest_bid: u64,
    pub highest_token: u64,

    pub bid_floor: u64,
    pub token_floor: u64,
    pub min_bid_increment: u64,
    pub min_bid_token_increment: u64,
...
impl OpenAuction {
    pub const LEN: usize = DISCRIMINATOR_LENGTH
        ...
        + U64_LENGTH // highest token
        + U64_LENGTH // bid floor
        + U64_LENGTH // min bid increment
        + U64_LENGTH // bid token floor
        + U64_LENGTH // min token bid increment
        + U8_LENGTH; // bump
}
